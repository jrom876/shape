...
COPY . /home/jake/sandbox/shape/
WORKDIR /home/jake/sandbox/shape/

# This command compiles your app using G++, adjust for your source code
# Be sure to include ALL .cpp files called in the main
RUN g++ -o mainShape main.cpp shape.cpp 
